...
Top_Style = "logo_sm"; // [base_sm:Plain - Single Material, base_mm2:Plain - Two Materials, radar_sm:Radar - Single Material, logo_sm:Logo - Single Material, logo_mm2:Logo - Two Materials, logo_mm3:Logo - Three Materials, hex_sm:Hexagons - Single Material, hex_mm2:Hexagons - Two Materials, slots_sm:Slots - Single Material, mesh_sm:Mesh - Single Material, pihole_sm:Pi-hole Logo - Single Material, pihole_mm4:Pi-hole Logo - Four Materials]
...
module case_mesh() {
    ...
    difference() {
        ...
        else if (Top_Style == "radar_sm"){
          translate([-10,56.5/2,15-0.1]) 
            linear_extrude(3) scale(0.45) rotate(180) translate([-100/2,-77/2]) 
              import("RadarIcon.svg");
        }
