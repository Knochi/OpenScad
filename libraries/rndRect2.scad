...
rndRect(size=[20,20,1],radius=3);

module rndRect(size=[10,10,1],radius=1,drill=1,center=true,diff="none",label="none",drillOffset=[0,0]) {
  fudge=0.1;
  ...
  cntrOffset = center ? [0,0,-size.z/2] : [size.x * 0.5,size.y *0.5,0];
